"""
Django settings for rongever project.
...
SECRET_KEY = 'django-insecure-+436i@uvojtef6sg5n5=lkz@q_=yamoj1tdco(_dll^ohw5z6d'
...
WSGI_APPLICATION = 'rongever.wsgi.application'
